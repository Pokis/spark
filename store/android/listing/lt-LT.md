# „Google Play“ aprašas — lietuvių kalba

## Programos pavadinimas

```text
Spark ADHD įpročių sekiklis
```
...
PRIVATUMAS PAGAL NUMATYTUOSIUS NUSTATYMUS
Pirmoji „Spark“ versija veikia be paskyros ir serverio. Įpročiai, užrašai, rutinos, susikaupimo istorija ir pažanga lieka jūsų įrenginyje. Pasirenkamos šifruotos atsarginės kopijos kuriamos tik jūsų pasirinktoje vietoje. „Spark“ nerodo reklamos ir nenaudoja trečiųjų šalių elgsenos analizės.

„Spark“ yra planavimo ir savitvarkos priemonė. Ji nediagnozuoja, negydo ir neužkerta kelio ADHD ar kitoms sveikatos būklėms ir nepakeičia profesionalios pagalbos.
```
...
programos versiją, kurioje visos debesijos ir pirkimo funkcijos išjungtos.
