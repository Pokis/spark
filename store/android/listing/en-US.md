...
PRIVATE BY DEFAULT
The first Spark release works without an account or server. Habits, notes, routines, focus history, and progress remain on your device. Optional encrypted backups are created only when you choose a location. Spark includes no advertising or third-party behavior analytics.

Spark is a planning and self-management tool. It does not diagnose, treat, cure, or prevent ADHD or any medical condition and is not a substitute for professional care.
```

## Recommended store choices
...
the declarations have been revised.
